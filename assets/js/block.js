(function (blocks, blockEditor, i18n, element, components) {
    ...
    var pluginUrl = airGutTgPluginData.pluginUrl;
    ...
    blocks.registerBlockType('air-gut-tg/telegram-group', {
        ...
        example: {
            attributes: {
                title: __('Title Telegram Сommunity', 'air-telegram-group'),
                description: __('The description of Your Telegram channel or group can be a simple sentence. Additionally, you can add phrases that will change at specific intervals.', 'air-telegram-group'),
                lineClamp: 4,
                maxWidth: 600,
                margin: 60,
            },
        ...
        attributes: {
            ...
            image: {
                type: 'string',
                default: pluginUrl + 'assets/img/tg.svg',
            },
            margin: {
                type: 'number',
                default: 15,
                        ...
                        el(BaseControl, {label: __('Group TG Image', 'air-telegram-group')},
                            el('div', {className: 'components-base-control__field'},
                                ...
                                el('div', {className: 'air-telegramm__icon-edit'}, [
                                    el('img', {
                                        src: image || pluginUrl + 'assets/img/tg.svg',
                                        alt: 'Telegram',
                                        style: {maxWidth: '100%'}
                                    })
                                ]),
